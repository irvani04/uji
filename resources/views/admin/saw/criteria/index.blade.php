                        ...
                        <table class="table table-bordered" id="data" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <a href="{{route('criteria.show',['id'=>$criteria->id])}}" class="btn btn-sm btn-primary"><i class="fas fa-code-branch"></i></a>
                                    <a href="/admin/criteria/{{$criteria->id}}/edit" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                    <form action="/admin/criteria/{{$criteria->id}}/delete" method="post" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
