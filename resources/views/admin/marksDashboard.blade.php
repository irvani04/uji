...
@section('space-work')
    ...
    <!-- Modal -->
    <div class="modal fade" id="editMarksModal" tabindex="-1" role="dialog" aria-labelledby="editMarksModal"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" onkeypress="return event.charCode >=48 && event.charCode<=57 || event.charCode == 46" name="marks" placeholder="Enter Marks/Q" id="marks" required>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-sm-4">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input type="text" onkeypress="return event.charCode >=48 && event.charCode<=57 || event.charCode == 46" name="pass_marks" placeholder="Enter Passing Marks/Q" id="pass_marks" required>
                            </div>
                        </div>
                    </div>
